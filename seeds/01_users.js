  ...
  return knex('users').del()
    .then(function() {
      ...
      return knex('users').insert([{
          ...
          password: '$2a$10$dTwA4lpkETg5mR0BbL1QZO50J1VpOBl0eEUG1heMoe9NxlSGFye0y',
          is_admin: false
        },
        {
          id: 2,
          colName: 'coach2@gmail.com',
          password: '$2a$10$G4BNzRZSfvYUCgKrlI1ryu1.0sstq5JLkdguVOl6HjXOOJ9wbxADC',
          is_admin: false
        },
        {
          id: 3,
          colName: 'admin1@gmail.com',
